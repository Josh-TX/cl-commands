...
alias u="{ echo -e 'user name:password:user Id:primary group id:home directory:shell'; getent passwd | awk -F : \"\\\$3 >= 1000 && \\\$1 != \\\"nobody\\\" {print}\" | cut -d : -f 5 --complement; }  | column -t -s ':'"
